...
from rl_algorithms.ppo_network import Agent, make_env
...
def parse_args():
    ...
    parser.add_argument("--source", type=str, default='./dataset',
                        help="Digitized WSI data directory")
    parser.add_argument("--label_list", type=str, default='./dataset/label_list.csv',
                        help="the label list of the WSI data")

    # Experimental arguments
    parser.add_argument("--env-id", type=str, default="WSI_observation_env",
    ...
    parser.add_argument("--wandb-project-name", type=str, default="RLogist",
                        help="the wandb's project name")
    parser.add_argument("--wandb-entity", type=str, default=None,
                        help="the entity (team) of wandb's project")

    # Algorithm specific arguments (PPO)
